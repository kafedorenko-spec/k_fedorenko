Вот диаграмма вариантов использования для **«Гуси-лебеди» (Система верификации пути)** , оформленная в точности в том же стиле, что и «Управление золотыми активами»:
